...
class ViewTable extends Component {
    ...
    return (
      <View>
        ...
        {(this.state.status === 'In-Progress' ||
          ...
          this.getResults()}
        {this.state.status === 'In-Progress' || (
          <Button text="Record game result" onPress={this.createResult} />
        )}
      </View>
    )
  }
  ...
  render() {
    return (
      <View>
        {this.getCurrentPlayers()}
        <ButtonSmall text="Request to join" onPress={this.createJoinRequest} />
        <ButtonSmall text="Back" onPress={this.props.return} />
      </View>
    )
  }
}
