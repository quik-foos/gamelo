...
class Profile extends Component {
  state = {
    ...
    gameSummary: [
      ...
      { game: 'Connect 4', played: 214, elo: 1640 },
      { game: 'Monopoly', played: 42, elo: 1200 }
    ]
  }
        ...
        {this.state.gameSummary.map((game, key) => {
          return (
            <View style={styles.eloGame} key={key}>
              <Text style={styles.summaryGameName}>{game.game}</Text>
              <Text style={styles.eloGameName}>Elo:{game.elo}</Text>
              <Text>Played: {game.played}</Text>
            </View>
          )
        })}
      </View>
        ...
        <View style={styles.body}>
          <View style={styles.bodyContent}>
            ...
            <Text style={styles.description}>
              I love strategy board games! Always up for a round of Catan or
              quik fooz
            </Text>
